...
** librarian support
   - install the [[https://github.com/applicationsonline/librarian][librarian]] gem and run 'librarian-chef install' to build
     the cookbooks directory and populate it with cookbooks.
